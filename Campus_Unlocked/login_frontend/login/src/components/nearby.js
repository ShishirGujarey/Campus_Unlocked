...
const arr = [
    ["RM/KD", "Nursery", 120, 3, "DOAA Canteen", 400, 5, "Auditorium", 350, 5],
    ["Cafe Coffee Day", "Library", 10, 1, "IIT Kanpur Stadium", 550, 7, "DOAA Canteen", 500, 6],
    ["Library", "Cafe Coffee Day", 10, 1, "RM KD Building", 750, 9, "DOAA Canteen", 500, 6],
    ["Nursery", "RM KD Building", 120, 3, "DOAA Canteen", 400, 6, "Auditorium", 250, 3],
    ["Open Air Theatre", "Hockey Ground", 10, 1, "OAT", 10, 1, "Swimming Pool", 50, 2],
    ["Pronite Ground", "Oxidation Pond", 100, 3, "Swimming Pool", 450, 6, "OAT", 500, 6],
    ["Mama Mio", "OAT", 350, 4, "Hockey Ground", 350, 4, "New SAC", 370, 5],
    ["Hockey Ground", "OAT", 10, 1, "New SAC", 10, 1, "Swimming Pool", 50, 2],
    ["IIT Kanpur Stadium", "Old SAC", 270, 3, "Outreach", 450, 6, "Tennis Court", 450, 6],
    ["Swimming Pool", "New SAC", 50, 2, "OAT", 60, 2, "Hockey Ground", 60, 2],
    ["MT Point", "Tennis Court", 350, 4, "Old SAC", 450, 5, "Library", 600, 7],
    ["Auditorium", "Nursery", 250, 3, "RM KD Building", 350, 5, "Library", 500, 11],
    ["Tennis Court", "Old SAC", 260, 3, "MT Point", 350, 4, "IIT Kanpur Stadium", 450, 5],
    ["Old SAC", "Tennis Court", 260, 3, "IIT Kamnpur Stadium", 270, 3, "Outreach", 550, 4],
    ["New SAC", "Hockey Ground", 10, 1, "OAT", 10, 1, "Swimming Pool", 50, 2],
    ["Oxidation Pond", "Pronite Ground", 100, 3, "Swimming Pool", 550, 7, "OAT", 600, 8],
    ["DOAA Canteen", "MT Point", 350, 4, "RM KD Building", 400, 5, "Nursery", 400, 5],
    ["Park 67", "Auditorium", 950, 12, "Outreach", 1000, 12, "Cafe Coffee Day", 1100, 13],
    ["Flight Laboratory", "Nursery", 750, 9, "RM KD Building", 750, 9, "DOAA Canteen", 750, 10],
    ["Outreach", "IIT Kanpur Stadium", 450, 6, "Old SAC", 550, 7, "Tennis Court", 800, 10],
];
...
dropdown.addEventListener('change', () => {
    ...
    if (dropdown.value === "rkd") {
        ...
        name1.classList.add('loc_name');
        name1.textContent = `${arr[0][1]}`;


        image1.classList.add('image_tag');
        image1.src = `/${arr[0][1]}.jpeg`;
        const image2 = document.createElement('img');
        const name2 = document.createElement('h2');
        name2.classList.add('loc_name');
        name2.textContent = `${arr[0][4]}`;
        image2.src = `/${arr[0][4]}.jpeg`;
        image2.classList.add('image_tag');
        const image3 = document.createElement('img');
        const name3 = document.createElement('h2');
        name3.classList.add('loc_name');
        name3.textContent = `${arr[0][7]}`;
        image3.src = `/${arr[0][7]}.jpeg`;
        image3.classList.add('image_tag');
        ...
        const name1 = document.createElement('h2');
        name1.classList.add('loc_name');
        name1.textContent = `${arr[1][1]}`;
        image1.classList.add('image_tag');
        image1.src = `/${arr[1][1]}.jpeg`;
        const image2 = document.createElement('img');
        const name2 = document.createElement('h2');
        name2.classList.add('loc_name');
        name2.textContent = `${arr[1][4]}`;
        image2.src = `/${arr[1][4]}.jpeg`;
        image2.classList.add('image_tag');
        const image3 = document.createElement('img');
        const name3 = document.createElement('h2');
        name3.classList.add('loc_name');
        name3.textContent = `${arr[1][7]}`;
        image3.src = `/${arr[1][7]}.jpeg`;
        image3.classList.add('image_tag');
        ...
        const name1 = document.createElement('h2');
        name1.classList.add('loc_name');
        name1.textContent = `${arr[2][1]}`;
        image1.classList.add('image_tag');
        image1.src = `/${arr[2][1]}.jpeg`;
        const image2 = document.createElement('img');
        const name2 = document.createElement('h2');
        name2.classList.add('loc_name');
        name2.textContent = `${arr[2][4]}`;
        image2.src = `/${arr[2][4]}.jpeg`;
        image2.classList.add('image_tag');
        const image3 = document.createElement('img');
        const name3 = document.createElement('h2');
        name3.classList.add('loc_name');
        name3.textContent = `${arr[2][7]}`;
        image3.src = `/${arr[2][7]}.jpeg`;
        image3.classList.add('image_tag');
        ...
        const name1 = document.createElement('h2');
        name1.classList.add('loc_name');
        name1.textContent = `${arr[3][1]}`;
        image1.classList.add('image_tag');
        image1.src = `/${arr[3][1]}.jpeg`;
        const image2 = document.createElement('img');
        const name2 = document.createElement('h2');
        name2.classList.add('loc_name');
        name2.textContent = `${arr[3][4]}`;
        image2.src = `/${arr[3][4]}.jpeg`;
        image2.classList.add('image_tag');
        const image3 = document.createElement('img');
        const name3 = document.createElement('h2');
        name3.classList.add('loc_name');
        name3.textContent = `${arr[3][7]}`;
        image3.src = `/${arr[3][7]}.jpeg`;
        image3.classList.add('image_tag');
        ...
        const name1 = document.createElement('h2');
        name1.classList.add('loc_name');
        name1.textContent = `${arr[4][1]}`;
        image1.classList.add('image_tag');
        image1.src = `/${arr[4][1]}.jpeg`;
        const image2 = document.createElement('img');
        const name2 = document.createElement('h2');
        name2.classList.add('loc_name');
        name2.textContent = `${arr[4][4]}`;
        image2.src = `/${arr[4][4]}.jpeg`;
        image2.classList.add('image_tag');
        const image3 = document.createElement('img');
        const name3 = document.createElement('h2');
        name3.classList.add('loc_name');
        name3.textContent = `${arr[4][7]}`;
        image3.src = `/${arr[4][7]}.jpeg`;
        image3.classList.add('image_tag');
        ...
        const name1 = document.createElement('h2');
        name1.classList.add('loc_name');
        name1.textContent = `${arr[5][1]}`;
        image1.classList.add('image_tag');
        image1.src = `/${arr[5][1]}.jpeg`;
        const image2 = document.createElement('img');
        const name2 = document.createElement('h2');
        name2.classList.add('loc_name');
        name2.textContent = `${arr[5][4]}`;
        image2.src = `/${arr[5][4]}.jpeg`;
        image2.classList.add('image_tag');
        const image3 = document.createElement('img');
        const name3 = document.createElement('h2');
        name3.classList.add('loc_name');
        name3.textContent = `${arr[5][7]}`;
        image3.src = `/${arr[5][7]}.jpeg`;
        image3.classList.add('image_tag');
        ...
        const name1 = document.createElement('h2');
        name1.classList.add('loc_name');
        name1.textContent = `${arr[6][1]}`;
        image1.classList.add('image_tag');
        image1.src = `/${arr[6][1]}.jpeg`;
        const image2 = document.createElement('img');
        const name2 = document.createElement('h2');
        name2.classList.add('loc_name');
        name2.textContent = `${arr[6][4]}`;
        image2.src = `/${arr[6][4]}.jpeg`;
        image2.classList.add('image_tag');
        const image3 = document.createElement('img');
        const name3 = document.createElement('h2');
        name3.classList.add('loc_name');
        name3.textContent = `${arr[6][7]}`;
        image3.src = `/${arr[6][7]}.jpeg`;
        image3.classList.add('image_tag');
        ...
        const name1 = document.createElement('h2');
        name1.classList.add('loc_name');
        name1.textContent = `${arr[7][1]}`;
        image1.classList.add('image_tag');
        image1.src = `/${arr[7][1]}.jpeg`;
        const image2 = document.createElement('img');
        const name2 = document.createElement('h2');
        name2.classList.add('loc_name');
        name2.textContent = `${arr[7][4]}`;
        image2.src = `/${arr[7][4]}.jpeg`;
        image2.classList.add('image_tag');
        const image3 = document.createElement('img');
        const name3 = document.createElement('h2');
        name3.classList.add('loc_name');
        name3.textContent = `${arr[7][7]}`;
        image3.src = `/${arr[7][7]}.jpeg`;
        image3.classList.add('image_tag');
        ...
        const name1 = document.createElement('h2');
        name1.classList.add('loc_name');
        name1.textContent = `${arr[8][1]}`;
        image1.classList.add('image_tag');
        image1.src = `/${arr[8][1]}.jpeg`;
        const image2 = document.createElement('img');
        const name2 = document.createElement('h2');
        name2.classList.add('loc_name');
        name2.textContent = `${arr[8][4]}`;
        image2.src = `/${arr[8][4]}.jpeg`;
        image2.classList.add('image_tag');
        const image3 = document.createElement('img');
        const name3 = document.createElement('h2');
        name3.classList.add('loc_name');
        name3.textContent = `${arr[8][7]}`;
        image3.src = `/${arr[8][7]}.jpeg`;
        image3.classList.add('image_tag');
        ...
        const name1 = document.createElement('h2');
        name1.classList.add('loc_name');
        name1.textContent = `${arr[9][1]}`;
        image1.classList.add('image_tag');
        image1.src = `/${arr[9][1]}.jpeg`;
        const image2 = document.createElement('img');
        const name2 = document.createElement('h2');
        name2.classList.add('loc_name');
        name2.textContent = `${arr[9][4]}`;
        image2.src = `/${arr[9][4]}.jpeg`;
        image2.classList.add('image_tag');
        const image3 = document.createElement('img');
        const name3 = document.createElement('h2');
        name3.classList.add('loc_name');
        name3.textContent = `${arr[9][7]}`;
        image3.src = `/${arr[9][7]}.jpeg`;
        image3.classList.add('image_tag');
        ...
        const name1 = document.createElement('h2');
        name1.classList.add('loc_name');
        name1.textContent = `${arr[10][1]}`;
        image1.classList.add('image_tag');
        image1.src = `/${arr[10][1]}.jpeg`;
        const image2 = document.createElement('img');
        const name2 = document.createElement('h2');
        name2.classList.add('loc_name');
        name2.textContent = `${arr[10][4]}`;
        image2.src = `/${arr[10][4]}.jpeg`;
        image2.classList.add('image_tag');
        const image3 = document.createElement('img');
        const name3 = document.createElement('h2');
        name3.classList.add('loc_name');
        name3.textContent = `${arr[10][7]}`;
        image3.src = `/${arr[10][7]}.jpeg`;
        image3.classList.add('image_tag');
        ...
        const name1 = document.createElement('h2');
        name1.classList.add('loc_name');
        name1.textContent = `${arr[11][1]}`;
        image1.classList.add('image_tag');
        image1.src = `/${arr[11][1]}.jpeg`;
        const image2 = document.createElement('img');
        const name2 = document.createElement('h2');
        name2.classList.add('loc_name');
        name2.textContent = `${arr[11][4]}`;
        image2.src = `/${arr[11][4]}.jpeg`;
        image2.classList.add('image_tag');
        const image3 = document.createElement('img');
        const name3 = document.createElement('h2');
        name3.classList.add('loc_name');
        name3.textContent = `${arr[11][7]}`;
        image3.src = `/${arr[11][7]}.jpeg`;
        image3.classList.add('image_tag');
        ...
        const name1 = document.createElement('h2');
        name1.classList.add('loc_name');
        name1.textContent = `${arr[12][1]}`;
        image1.classList.add('image_tag');
        image1.src = `/${arr[12][1]}.jpeg`;
        const image2 = document.createElement('img');
        const name2 = document.createElement('h2');
        name2.classList.add('loc_name');
        name2.textContent = `${arr[12][4]}`;
        image2.src = `/${arr[12][4]}.jpeg`;
        image2.classList.add('image_tag');
        const image3 = document.createElement('img');
        const name3 = document.createElement('h2');
        name3.classList.add('loc_name');
        name3.textContent = `${arr[12][7]}`;
        image3.src = `/${arr[12][7]}.jpeg`;
        image3.classList.add('image_tag');
        ...
        const name1 = document.createElement('h2');
        name1.classList.add('loc_name');
        name1.textContent = `${arr[13][1]}`;
        image1.classList.add('image_tag');
        image1.src = `/${arr[13][1]}.jpeg`;
        const image2 = document.createElement('img');
        const name2 = document.createElement('h2');
        name2.classList.add('loc_name');
        name2.textContent = `${arr[13][4]}`;
        image2.src = `/${arr[13][4]}.jpeg`;
        image2.classList.add('image_tag');
        const image3 = document.createElement('img');
        const name3 = document.createElement('h2');
        name3.classList.add('loc_name');
        name3.textContent = `${arr[13][7]}`;
        image3.src = `/${arr[13][7]}.jpeg`;
        image3.classList.add('image_tag');
        ...
        const name1 = document.createElement('h2');
        name1.classList.add('loc_name');
        name1.textContent = `${arr[14][1]}`;
        image1.classList.add('image_tag');
        image1.src = `/${arr[14][1]}.jpeg`;
        const image2 = document.createElement('img');
        const name2 = document.createElement('h2');
        name2.classList.add('loc_name');
        name2.textContent = `${arr[14][4]}`;
        image2.src = `/${arr[14][4]}.jpeg`;
        image2.classList.add('image_tag');
        const image3 = document.createElement('img');
        const name3 = document.createElement('h2');
        name3.classList.add('loc_name');
        name3.textContent = `${arr[14][7]}`;
        image3.src = `/${arr[14][7]}.jpeg`;
        image3.classList.add('image_tag');
        ...
        const name1 = document.createElement('h2');
        name1.classList.add('loc_name');
        name1.textContent = `${arr[15][1]}`;
        image1.classList.add('image_tag');
        image1.src = `/${arr[15][1]}.jpeg`;
        const image2 = document.createElement('img');
        const name2 = document.createElement('h2');
        name2.classList.add('loc_name');
        name2.textContent = `${arr[15][4]}`;
        image2.src = `/${arr[15][4]}.jpeg`;
        image2.classList.add('image_tag');
        const image3 = document.createElement('img');
        const name3 = document.createElement('h2');
        name3.classList.add('loc_name');
        name3.textContent = `${arr[15][7]}`;
        image3.src = `/${arr[15][7]}.jpeg`;
        image3.classList.add('image_tag');
        ...
        const name1 = document.createElement('h2');
        name1.classList.add('loc_name');
        name1.textContent = `${arr[16][1]}`;
        image1.classList.add('image_tag');
        image1.src = `/${arr[16][1]}.jpeg`;
        const image2 = document.createElement('img');
        const name2 = document.createElement('h2');
        name2.classList.add('loc_name');
        name2.textContent = `${arr[16][4]}`;
        image2.src = `/${arr[16][4]}.jpeg`;
        image2.classList.add('image_tag');
        const image3 = document.createElement('img');
        const name3 = document.createElement('h2');
        name3.classList.add('loc_name');
        name3.textContent = `${arr[16][7]}`;
        image3.src = `/${arr[16][7]}.jpeg`;
        image3.classList.add('image_tag');
        ...
        const name1 = document.createElement('h2');
        name1.classList.add('loc_name');
        name1.textContent = `${arr[17][1]}`;
        image1.classList.add('image_tag');
        image1.src = `/${arr[17][1]}.jpeg`;
        const image2 = document.createElement('img');
        const name2 = document.createElement('h2');
        name2.classList.add('loc_name');
        name2.textContent = `${arr[17][4]}`;
        image2.src = `/${arr[17][4]}.jpeg`;
        image2.classList.add('image_tag');
        const image3 = document.createElement('img');
        const name3 = document.createElement('h2');
        name3.classList.add('loc_name');
        name3.textContent = `${arr[17][7]}`;
        image3.src = `/${arr[17][7]}.jpeg`;
        image3.classList.add('image_tag');
        ...
        const name1 = document.createElement('h2');
        name1.classList.add('loc_name');
        name1.textContent = `${arr[18][1]}`;
        image1.classList.add('image_tag');
        image1.src = `/${arr[18][1]}.jpeg`;
        const image2 = document.createElement('img');
        const name2 = document.createElement('h2');
        name2.classList.add('loc_name');
        name2.textContent = `${arr[18][4]}`;
        image2.src = `/${arr[18][4]}.jpeg`;
        image2.classList.add('image_tag');
        const image3 = document.createElement('img');
        const name3 = document.createElement('h2');
        name3.classList.add('loc_name');
        name3.textContent = `${arr[18][7]}`;
        image3.src = `/${arr[18][7]}.jpeg`;
        image3.classList.add('image_tag');
        ...
        const name1 = document.createElement('h2');
        name1.classList.add('loc_name');
        name1.textContent = `${arr[19][1]}`;
        image1.classList.add('image_tag');
        image1.src = `/${arr[19][1]}.jpeg`;
        const image2 = document.createElement('img');
        const name2 = document.createElement('h2');
        name2.classList.add('loc_name');
        name2.textContent = `${arr[19][4]}`;
        image2.src = `/${arr[19][4]}.jpeg`;
        image2.classList.add('image_tag');
        const image3 = document.createElement('img');
        const name3 = document.createElement('h2');
        name3.classList.add('loc_name');
        name3.textContent = `${arr[19][7]}`;
        image3.src = `/${arr[19][7]}.jpeg`;
        image3.classList.add('image_tag');
    ...
    function createSelect() {
        ...
        for ( i = 0, len = buttonSelect.length; i < len; i++) {
  ...
  return (
    <div class="comp_dropdown">
      ...
      <option value="rkd">RM/KD Building</option>
      <option value="ccd">Cafe Coffee Day</option>
      <option value="lib">Library</option>
      <option value="nur">Nursery</option>
      <option value="oat">Open Air Theatre</option>
      <option value="pro">Pronite Ground</option>
      <option value="mmo">Mama Mio</option>
      <option value="hcg">Hockey Ground</option>
      <option value="iks">IIT Kanpur Stadium</option>
      <option value="swp">Swimming Pool</option>
      <option value="mt">MT Point</option>
      <option value="aud">Auditorium</option>
      <option value="tnc">Tennis Court</option>
      <option value="old">Old SAC</option>
      <option value="new">New SAC</option>
      <option value="oxp">Oxidation Pond</option>
      <option value="dcn">DOAA Canteen</option>
      <option value="pg7">Park 67</option>
      <option value="flb">Flight Laboratory</option>
      <option value="out">Outreach</option>
	</select>
